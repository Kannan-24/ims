...
use App\Models\ims\PurchaseItem;
...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ims.purchases.index', compact('purchases'));
    }
    ...
    public function create()
    {
        ...
        return view('ims.purchases.create', [
            'suppliers' => $suppliers,
            'products' => $products,
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('ims.purchases.show', compact('purchase', 'filePath'));
    }
    ...
    public function edit(Purchase $purchase)
    {
        ...
        return view('ims.purchases.edit', [
            'purchase' => $purchase,
            'suppliers' => $suppliers,
            'products' => $products,
    ...
    public function update(Request $request, Purchase $purchase)
    {
        ...
        $latestBatch = \App\Models\ims\Stock::latest()->first();
        $nextLetter = 'A';
        $nextNumber = 1;
