            ...
            <div class="p-8 bg-white border border-gray-200 rounded-lg shadow-lg">
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="zip" id="zip" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="gstno" id="gstno" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>
