            ...
            <div class="p-8 bg-white border border-gray-200 rounded-lg shadow-lg">
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="company_name" id="company_name" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="zip_code" id="zip_code" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 font-bold">Country:</label>
                        <input type="text" name="country" id="country" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 font-bold">GST Number:</label>
                        <input type="text" name="gst_number" id="gst_number" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>

                    <div id="contact-persons-container">
                        <div class="mb-4 contact-person">
                            <label class="block mb-2 font-bold">Contact Person Name:</label>
                            <input type="text" name="contact_persons[0][name]" class="w-full px-4 py-2 border rounded-lg" required>

                            <label class="block mb-2 font-bold">Contact Person Phone:</label>
                            <input type="text" name="contact_persons[0][phone_no]" class="w-full px-4 py-2 border rounded-lg" required>

                            <label class="block mb-2 font-bold">Contact Person Email:</label>
                            <input type="email" name="contact_persons[0][email]" class="w-full px-4 py-2 border rounded-lg" required>
                        </div>
                    </div>
