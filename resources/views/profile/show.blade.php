            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden mb-6">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-8 text-white">
                    <div class="flex items-center">
                        <div class="relative">
                            ...
                            @else
                                <div
                                    class="flex items-center justify-center w-20 h-20 text-2xl font-bold text-blue-600 bg-white rounded-full border-4 border-white border-opacity-30 uppercase">
                ...
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ \Carbon\Carbon::parse($user->dob)->age }}
                            </div>
                            <div class="text-xs text-gray-500">Age</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-purple-600">
                                {{ \Carbon\Carbon::parse($user->created_at)->format('M Y') }}</div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($user->created_at)->format('M d, Y') }}</p>
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">
                                    ...
                                    ({{ \Carbon\Carbon::parse($user->dob)->age }} years)</p>
                            </div>
                            <div>
            ...
            <div class="flex items-center justify-center min-h-screen px-4 text-center">
                ...
                <div class="relative bg-white rounded-lg p-8 max-w-md w-full">
                    <div class="text-center">
                        ...
                        <div
                            class="mx-auto w-64 h-64 bg-gray-100 border border-gray-300 rounded-lg flex items-center justify-center mb-4">
