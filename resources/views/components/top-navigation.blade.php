<header
    class="fixed top-0 right-0 z-50 bg-white border-b border-gray-200 h-16 transition-all duration-300 ease-in-out lg:left-64 left-0"
    :class="{ 'lg:left-24': sidebarCollapsed && !sidebarHovering, 'lg:left-64': !sidebarCollapsed || (sidebarCollapsed &&
            sidebarHovering) }">
    <div class="flex items-center justify-between h-full px-6">
        ...
        <div class="flex items-center space-x-4">
            ...
            <button @click="sidebarOpen = !sidebarOpen"
                class="p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-md lg:hidden">
        ...
        <div class="flex items-center space-x-2">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open"
                    class="relative p-2.5 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex items-start p-3 bg-blue-50 rounded-lg border border-blue-100">
                                ...
                                <div class="ml-3 flex-1 min-w-0">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full font-medium">Live</span>
                                    </div>
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open"
                    class="flex items-center space-x-3 text-gray-700 hover:text-gray-900 p-2 hover:bg-gray-100 rounded-lg transition-colors">
                    ...
                    <div class="p-4 border-b border-gray-100">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-medium text-gray-900 truncate">{{ auth()->user()->name ?? 'John Doe' }}
                                </p>
                                <p class="text-sm text-gray-500 truncate">
                                    {{ auth()->user()->email ?? 'john@company.com' }}</p>
                            </div>
                        </div>
                    </div>
