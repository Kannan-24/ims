<div class="mb-6">
    <nav class="flex items-center justify-between p-4 bg-gray-800 border border-gray-700 rounded-lg shadow-md"
        ...
        @if (count($segments) == 1 && !in_array($lastSegment, ['profile', 'account-settings', 'stocks', 'payments']))
