...
<div class="mt-6 bg-gray-100 p-4 rounded">
    ...
    <div class="grid grid-cols-2 gap-4">
        <!-- Image Upload -->
        <div>
            <label for="purchase_image" class="block text-gray-700 font-bold mb-2">Upload Image:</label>
            <input type="file" name="purchase_image" id="purchase_image"
                accept="image/*" class="w-full border rounded px-3 py-2">
        ...
        <!-- PDF Upload -->
        <div>
            <label for="purchase_pdf" class="block text-gray-700 font-bold mb-2">Upload PDF:</label>
            <input type="file" name="purchase_pdf" id="purchase_pdf"
                accept="application/pdf" class="w-full border rounded px-3 py-2">
            @error('purchase_pdf')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
