...
<div style="max-width:600px;">
    ...
    <p style="font-size:14px; margin:0 0 12px; line-height:1.5;">We detected <strong>{{ $attempts }}</strong> consecutive unsuccessful login attempts to your account. Review the details below and secure your account if necessary.</p>
    ...
    <p style="margin:0 0 20px;">
        <a href="{{ route('password.request') }}" style="background:#d32f2f; color:#fff; padding:10px 18px; font-size:14px; text-decoration:none; border-radius:4px; display:inline-block;">Reset Password</a>
        <a href="{{ route('account.settings') }}" style="margin-left:8px; background:#1a73e8; color:#fff; padding:10px 18px; font-size:14px; text-decoration:none; border-radius:4px; display:inline-block;">Manage Security</a>
    </p>
