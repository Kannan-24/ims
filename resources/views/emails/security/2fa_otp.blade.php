...
<div class="container">
    ...
    <p style="font-size:12px;color:#777">{{ config('company.name') }}, {{ config('company.address') }} — Report abuse: <a href="mailto:{{ config('company.abuse_email') }}">{{ config('company.abuse_email') }}</a></p>
</div>
</body>
</html>
