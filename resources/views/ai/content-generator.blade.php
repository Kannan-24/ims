                ...
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Powered by DeepSeek AI via OpenRouter
                            </p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p id="status-message" class="text-sm text-gray-500 dark:text-gray-400">Checking
                                configuration...</p>
                        </div>
                    </div>
            ...
            <div class="mb-8">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <nav class="-mb-px flex space-x-8">
                        ...
                        <button onclick="switchTab('quotation')" id="tab-quotation"
                ...
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div
                            ...
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Email Content Generator
                            </h2>
                            ...
                            <form id="email-form" class="space-y-4">
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Recipient
                                            Name</label>
                                    ...
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Company
                                            Name</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Subject
                                        Context</label>
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Invoice/Quote
                                            Number</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Additional
                                        Context</label>
                    ...
                    <div class="space-y-6">
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Generated Email Content
                                </h3>
                                <button onclick="copyToClipboard('email-output')"
                                    class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                    <i class="fas fa-copy mr-1"></i>Copy
                                </button>
                            </div>
                            <div id="email-output"
                                class="min-h-96 p-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <div id="quotation-tab" class="tab-content hidden">
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Quotation Terms
                                Generator</h2>
                            ...
                            <form id="quotation-form" class="space-y-4">
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="company_name"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                            placeholder="SKM & Company">
                                    </div>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Business
                                            Type</label>
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Quotation
                                            Amount</label>
                                        <input type="number" name="quotation_amount" step="0.01"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                            placeholder="50000.00">
                                    </div>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Validity
                                            Period (Days)</label>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="delivery_terms"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                        placeholder="Delivery within 30 days">
                                </div>

                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Items/Services
                                        Description</label>
                                    <textarea name="items_description" rows="3"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                        placeholder="Web application development, mobile app, maintenance..."></textarea>
                                </div>

                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Special
                                        Conditions</label>
                                    <textarea name="special_conditions" rows="2"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                        placeholder="Any special conditions or requirements..."></textarea>
                                </div>

                                <button type="submit"
                                    class="w-full px-4 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors flex items-center justify-center space-x-2">
                    ...
                    <div class="space-y-6">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Generated Terms &
                                    Conditions</h3>
                                <button onclick="copyToClipboard('quotation-output')"
                                    class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                    <i class="fas fa-copy mr-1"></i>Copy
                                </button>
                            </div>
            ...
            <div id="custom-tab" class="tab-content hidden">
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Custom Content
                                Generator</h2>
                            ...
                            <form id="custom-form" class="space-y-4">
                                <div>
                                    ...
                                    <textarea name="prompt" rows="6"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                        placeholder="Enter your custom prompt here. For example: 'Write a professional email to follow up on a project proposal...'"></textarea>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Describe exactly what
                                        content you want to generate.</p>
                                </div>

                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Context
                                        Information (Optional)</label>
                                    <div class="space-y-2">
                                        <input type="text" name="context[customer_name]"
                                            placeholder="Customer Name"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                        <input type="text" name="context[project_name]" placeholder="Project Name"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                        <input type="text" name="context[amount]" placeholder="Amount"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                        <input type="text" name="context[date]" placeholder="Date"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                        <textarea name="context[additional_info]" rows="2" placeholder="Additional Information"
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add relevant context to
                                        improve the generated content.</p>
                                </div>
                    ...
                    <div class="space-y-6">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Generated Custom
                                    Content</h3>
                                <button onclick="copyToClipboard('custom-output')"
                                    class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                    <i class="fas fa-copy mr-1"></i>Copy
                                </button>
                            </div>
                            <div id="custom-output"
                                class="min-h-96 p-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
                                <div class="flex items-center justify-center h-32 text-gray-500 dark:text-gray-400">
                                    <div class="text-center">
    ...
    <script>
        ...
        async function generateContent(type, endpoint, outputId) {
            ...
            try {
                ...
                if (data.success) {
                    output.innerHTML =
                        `<div class="whitespace-pre-wrap text-gray-900 dark:text-gray-100">${data.content}</div>`;
        ...
        function showToast(message, type = 'info', duration = 5000) {
            ...
            toast.className =
                `${bgColors[type]} text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-3 transform transition-all duration-300 translate-x-full opacity-0`;
            toast.innerHTML = `
