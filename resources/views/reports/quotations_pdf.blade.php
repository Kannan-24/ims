...
<body>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        <!-- Quotation Report Title (Centered) -->
    ...
    <table>
        ...
        <tbody>
            @if ($quotations->isEmpty())
                <tr>
                    <td colspan="11" style="text-align: center;">No quotations found</td>
                </tr>
            @else
                @foreach ($quotations as $index => $quotation)
                    <tr>
                        ...
                        <td>{{ $quotation->customer->gst_number ?? 'N/A' }}</td>
                        ...
                        <td>{{ number_format($quotation->gst, 2) }}</td>
