            ...
            <div class="p-8 bg-white border border-gray-200 rounded-lg shadow-lg">
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="supplier_name" id="supplier_name" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 font-bold">Contact Person:</label>
                        <input type="text" name="contact_person" id="contact_person" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="postal_code" id="postal_code" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>

                    <div class="mb-4">
                        <label class="block mb-2 font-bold">GST Number:</label>
                        <input type="text" name="gst" id="gst" class="w-full px-4 py-2 border rounded-lg" required>
                    </div>
