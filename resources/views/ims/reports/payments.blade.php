<x-app-layout>
    ...
    <div class="py-6 mt-20 ml-4 sm:ml-64">
        <div class="w-full mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 p-4 rounded-lg shadow-md mb-6">
                <form method="GET" action="{{ route('reports.payments') }}" class="flex flex-wrap items-center gap-4">
                        ...
                        <table class="min-w-full text-left border-collapse table-auto">
                            <thead>
                                <tr class="text-sm text-gray-300 bg-gray-700 uppercase tracking-wider">
                                    ...
                                    <th class="px-6 py-4 border-b-2 border-gray-600">Paid</th>
                                    <th class="px-6 py-4 border-b-2 border-gray-600">Pending</th>
    ...
    <script>
        ...
        function submitDownload(type) {
            ...
            let action = type === 'pdf' ? "{{ route('reports.payments.pdf') }}" :
