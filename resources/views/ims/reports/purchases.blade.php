<x-app-layout>
    ...
    <div class="bg-white min-h-screen" x-data="purchaseReportsManager()" x-init="init()">
        <!-- Breadcrumbs -->
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-sm font-medium text-gray-500">Purchase Reports</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Purchase Reports</h1>
                    <p class="text-sm text-gray-600 mt-1">Track and analyze purchase orders and supplier transactions
                    </p>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $purchases->unique('supplier_id')->count() }}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                ₹{{ number_format($purchases->sum('total'), 2) }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500">Avg Purchase</p>
                            <p class="text-2xl font-bold text-gray-900">
                                ₹{{ number_format($purchases->avg('total'), 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6 mb-6 shadow-sm">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <div class="flex-1 min-w-[300px]">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Search Purchases</label>
                        <input type="text" x-model="searchQuery" @input="filterPurchases()"
                            placeholder="Search by invoice number, supplier name, or total..."
                ...
                <div class="overflow-x-auto">
                    @if ($purchases->isEmpty())
                        <div class="px-6 py-8 text-center">
                            ...
                            <p class="text-gray-500">No purchase records match your search criteria.</p>
                        </div>
                    @else
                        <table class="min-w-full divide-y divide-gray-200" id="purchaseTable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="purchaseTableBody">
                                @foreach ($purchases as $index => $purchase)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-blue-600">{{ $purchase->invoice_no }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
        ...
        <div x-show="showHelpModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50"
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-gray-900">Purchase Reports Help</h3>
                    ...
                    <div class="space-y-4 text-sm text-gray-600">
                        <div>
                            <h4 class="font-semibold text-gray-900 mb-2">Purchase Analytics:</h4>
                            <ul class="space-y-1">
                                <li>• View total purchase count and value</li>
                                <li>• Track unique suppliers and average purchase amounts</li>
                                <li>• Monitor purchase trends and patterns</li>
                            </ul>
                        </div>
                        <div>
                            <h4 class="font-semibold text-gray-900 mb-2">Search & Filter:</h4>
                            <ul class="space-y-1">
                                <li>• Search by invoice number, supplier name, or total</li>
    ...
    @push('scripts')
        <script>
            function purchaseReportsManager() {
                return {
                    showHelpModal: false,
                    ...
                    submitDownload(type) {
                        ...
                        const action = type === 'pdf' ? '{{ route('reports.purchases.pdf') }}' :
