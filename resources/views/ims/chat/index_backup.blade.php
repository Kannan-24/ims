<x-app-layout>
    ...
    <div class="flex h-screen bg-gray-100 overflow-hidden" x-data="chatApp()" x-init="init()"
        @keydown.escape="closeProfilePanel()"
        @keydown.enter.ctrl="$refs.messageInput && sendMessage()">
        <!-- Mobile Menu Overlay -->
        ...
        <!-- User List Sidebar -->
        <div class="flex flex-col w-full lg:w-80 bg-white border-r border-gray-200 lg:relative lg:translate-x-0 transition-transform duration-300 ease-in-out z-40"
