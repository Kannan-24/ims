<x-app-layout>
        ...
        <div class="w-full mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <input type="hidden" name="gst_status" id="gst_status" value="Active">
                    <input type="hidden" name="business_type" id="business_type">
                    <input type="hidden" name="gst_registration_date" id="gst_registration_date">
                </div>
    ...
    <script>
        ...
        // GST Validation and Auto-fill functionality
