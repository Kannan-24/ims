<x-app-layout>
    <x-slot name="title">
        Edit Note - {{ config('app.name', 'SKM') }}
    </x-slot>

    <div class="bg-white min-h-screen" x-data="editNoteApp()">
        <!-- Breadcrumbs -->
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Update your note content</p>
                </div>
        ...
        <div class="p-6">
            <div class="max-w-4xl mx-auto">
                <form action="{{ route('notes.update', $note->id) }}" method="POST" x-ref="noteForm">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('title') border-red-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <textarea id="content" 
                                                  name="content" 
                                                  rows="12"
                                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('content') border-red-300 @enderror"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <button type="submit" 
                                            ...
                                            x-text="isSubmitting ? 'Updating...' : 'Update Note'">
                                        Update Note
                                    </button>
                                </div>
                            </div>
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-blue-700">
                        <div><kbd class="bg-blue-100 px-2 py-1 rounded">Ctrl+S</kbd> Save changes</div>
