<x-app-layout>
    ...
    <div class="bg-white min-h-screen" x-data="quotationCreateManager()" x-init="init()">
        <!-- Breadcrumbs -->
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-sm font-medium text-gray-500">Create Quotation</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Generate quotation with products and services</p>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="terms_condition" rows="4"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                        placeholder="Enter terms and conditions" x-model="termsCondition"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div x-show="showHelpModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Create Quotation Help</h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                            <div>• GST calculations are automatic</div>
                            <div>• You can add multiple products and services</div>
                            <div>• Use search to find products/services quickly</div>
                            <div>• Review summary before creating quotation</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function quotationCreateManager() {
            return {
                activeTab: 'basic',
                selectedCustomer: '',
                ...
                setupCustomerData() {
                    // Setup customer data from Laravel
                ...
                calculateSummary() {
                    ...
                    this.products.forEach(product => {
                        ...
                        this.summary.product_total += product.total;
                    });
