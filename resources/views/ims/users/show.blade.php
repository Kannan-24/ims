<x-app-layout>
    ...
    <div class="bg-white min-h-screen" x-data="{ activeTab: 'personal' }">
        <!-- Breadcrumbs -->
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden mb-6">
                ...
                <div class="p-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($user->created_at)->format('M Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8">
                            ...
                            <button @click="activeTab = 'employment'"
                                :class="activeTab === 'employment' ? 'border-blue-500 text-blue-600' :
                                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                                class="py-4 px-1 border-b-2 font-medium text-sm">
                    ...
                    <div class="py-6">
                        ...
                        <div x-show="activeTab === 'personal'" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 mb-1">Date of
                                            Birth</label>
                                        <p class="text-sm text-gray-900">
                                            {{ \Carbon\Carbon::parse($user->dob)->format('M d, Y') }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 mb-1">Age</label>
                                        <p class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($user->dob)->age }}
                                            years</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 mb-1">Phone
                                            Number</label>
                                        <p class="text-sm text-gray-900">{{ $user->phone }}</p>
                                    </div>
                                </div>
                        ...
                        <!-- Employment Tab -->
                        <div x-show="activeTab === 'employment'" x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="bg-white border border-gray-200 rounded-lg p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 font-mono">
                                            {{ $user->employee_id ?? 'Not assigned' }}</p>
                                    </div>
                                    <div>
                                ...
                                @else bg-green-100 text-green-800 @endif">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 mb-1">Date of
                                            Joining</label>
                                        <p class="text-sm text-gray-900">
                                            {{ \Carbon\Carbon::parse($user->doj)->format('M d, Y') }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 mb-1">Years of
                                            Service</label>
                                        @php
                                        ...
                                        @endphp
                                        <p class="text-sm text-gray-900">
                                            {{ count($parts) ? implode(', ', $parts) : '0 days' }}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 mb-1">Contact
                                            Number</label>
                                        <p class="text-sm text-gray-900">{{ $user->phone }}</p>
                                    </div>
                                </div>
