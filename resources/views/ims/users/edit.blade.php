<x-app-layout>
    <x-slot name="title">
        {{ __('Edit User') }} - {{ config('app.name', 'IMS') }}
    </x-slot>

    <div class="bg-white min-h-screen" x-data="userEditManager()" x-init="init()">
        <!-- Breadcrumbs -->
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg p-6">
                           <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="employee_id" id="employee_id" value="{{ $user->employee_id }}" readonly
