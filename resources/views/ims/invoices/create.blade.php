<x-app-layout>
    ...
    <div class="bg-white min-h-screen" x-data="invoiceCreateManager()" x-init="init()">
        <!-- Breadcrumbs -->
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-sm font-medium text-gray-500">Create Invoice</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Generate invoice with products and services</p>
                </div>
        ...
        <!-- Content -->
        <div class="p-6">
            <form action="{{ route('invoices.store') }}" method="POST" id="invoiceForm" @submit.prevent="submitForm">
                @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="order_no" required
                                        ...
                                        x-model="orderType" @change="updateOrderType()">
                                ...
                                <!-- Custom Order Number -->
                                <div x-show="orderType === 'other'">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        Order Number <span class="text-red-500">*</span>
                                    </label>
                                    <textarea name="order_no_text" rows="2"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                        placeholder="Enter Order Number" x-model="customOrderNo"></textarea>
                                </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex justify-between text-lg">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <input type="number" name="courier_charges" x-model="courierCharges"
                                                    @input="calculateFinalTotal()"
                                                    class="w-24 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                                                    min="0" step="0.01" placeholder="0.00">
                                            </div>
                                        </div>
                                        <div
        ...
        <div x-show="showHelpModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Create Invoice Help</h2>
                ...
                <div class="p-6 space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Enter order details, select customer, and set
                                        dates.</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Include services if required for your invoice.</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Review totals and create the invoice.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                            <div>• <strong>Order Types:</strong> Choose between phone orders and custom</div>
                            <div>• <strong>GST calculations:</strong> Automatic based on product type</div>
                            <div>• <strong>Stock Check:</strong> Available stock is shown for each product</div>
                            <div>• <strong>Review Summary:</strong> Check all details before creating</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function invoiceCreateManager() {
            return {
                ...
                init() {
                    console.log('Initializing invoice create manager...');
                    this.bindKeyboardEvents();
                    this.setupCustomerData();
                    console.log('Invoice create manager initialized');
                },
                ...
                nextStep() {
                    if (this.activeTab === 'basic') {
                        ...
                        if (this.orderType === 'other' && !this.customOrderNo.trim()) {
                            alert('Please enter the custom order number.');
                            return;
                        }
                ...
                submitForm() {
                    ...
                    try {
                        ...
                        if (this.orderType === 'other' && !this.customOrderNo.trim()) {
                            this.errors.order = 'Please enter the custom order number.';
                            this.activeTab = 'basic';
                            alert('Please enter the custom order number.');
                            return;
                        }
        ...
        document.addEventListener('alpine:init', () => {
            console.log('Alpine.js initialized for invoice create');
        });

        // Add any additional event listeners or initialization
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Invoice create page loaded');
        });
    </script>
</x-app-layout>
