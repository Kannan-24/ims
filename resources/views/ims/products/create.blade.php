        ...
        <div x-show="showHelpModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Create Product Help</h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm text-gray-700">
                            <div>• <strong>Product Name:</strong> Unique name for the product</div>
                            <div>• <strong>HSN Code:</strong> Harmonized System of Nomenclature code for tax purposes
                            </div>
                            <div>• <strong>Unit Type:</strong> How the product is measured (kg, pieces, liters, etc.)
                            </div>
                            <div>• <strong>GST Percentage:</strong> Tax rate applicable to this product</div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                            <div class="space-y-2">
                                <div><strong>Product Name:</strong> Use descriptive, unique names</div>
                            ...
                            <div class="space-y-2">
                                <div><strong>Unit Type:</strong> Choose appropriate measurement unit</div>
                                <div><strong>GST Rate:</strong> Standard rates: 0%, 5%, 12%, 18%, 28%</div>
                                <div><strong>IGST:</strong> Use for inter-state transactions</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-700">Save Product</span>
