                ...
                <div x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="px-6 py-4">
                        <p class="text-sm text-gray-700">
                            ...
                            <strong x-text="productToDelete.name"></strong>?
                        </p>
                    </div>
        ...
        <div x-show="showHelpModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Product Management Help</h2>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-700">New Product</span>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2 text-sm text-gray-700">
                                <div><strong>View Product:</strong> Click on product name or use Enter on selected row
                                </div>
                                <div><strong>Edit Product:</strong> Click edit button or select and press E</div>
                                <div><strong>Delete Product:</strong> Click delete button with confirmation</div>
                            </div>
                            <div class="space-y-2 text-sm text-gray-700">
                                <div><strong>Search:</strong> Use search box or press S to focus</div>
                                <div><strong>New Product:</strong> Click '+' button or press N</div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2 text-sm text-gray-700">
                                ...
                                <div><strong>Filtering:</strong> Use search box to filter products</div>
                                <div><strong>Row Selection:</strong> Rows highlight on keyboard navigation</div>
                            </div>
                            <div class="space-y-2 text-sm text-gray-700">
                                <div><strong>Product Info:</strong> Name, Description, HSN Code, Unit Type</div>
                                <div><strong>Quick Actions:</strong> View, Edit, Delete buttons</div>
                                <div><strong>Product Icons:</strong> Visual indicators for different product types</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm text-blue-800">
                            ...
                            <div>• Search by product name, HSN code, or description</div>
                        ...
                        switch (e.key.toLowerCase()) {
                            ...
                            case 'enter':
                                ...
                                if (this.selectedRowIndex >= 0 && rows[this.selectedRowIndex]) {
                                    const productId = rows[this.selectedRowIndex].dataset.productId;
