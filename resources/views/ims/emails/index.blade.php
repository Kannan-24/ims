            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 mb-6 shadow-sm">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <span x-show="selectedEmails.length > 0" class="text-sm text-blue-600 font-medium">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div class="flex flex-col">
                                                ...
                                                <span
                                                    class="text-xs text-gray-500">{{ $email->created_at->format('h:i A') }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if ($email->is_draft)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            @foreach ($emails as $email)
                                <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-all duration-200 cursor-pointer grid-card"
                                    :class="selectedEmails.includes('{{ $email->id }}') ?
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        <div class="flex items-center">
                                            <input type="checkbox"
                                                :checked="selectedEmails.includes('{{ $email->id }}')" @click.stop
                                                @change="toggleEmailSelection('{{ $email->id }}')"
                                                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                            <div
                                                class="ml-2 w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                                    ...
                                    <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('emails.show', $email) }}" @click.stop
                                                class="text-blue-600 hover:text-blue-900 text-sm" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            @if ($email->is_draft)
                                                <a href="{{ route('emails.edit', $email) }}" @click.stop
                ...
                <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <kbd
                                        class="px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs">Ctrl+A</kbd>
                                </div>
                                <div class="flex justify-between">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-600">
                            ...
                            <li>• <strong>Bulk Actions:</strong> Delete multiple emails or mark as read simultaneously
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-600">
                            <li>• <strong>Contact Book Integration:</strong> Select recipients from unified contact book
                            </li>
                            <li>• <strong>CC/BCC Support:</strong> Send emails with carbon copy and blind carbon copy
                            </li>
                            <li>• <strong>Rich Text Editor:</strong> Compose emails with formatting and attachments</li>
                            <li>• <strong>Document Attachments:</strong> Attach invoices and quotations automatically
                            </li>
