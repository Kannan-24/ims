<x-app-layout>
    <div class="bg-white min-h-screen" x-data="paymentCreateManager()" x-init="init()">
        <!-- Breadcrumbs -->
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Add Payment Item</h1>
                    <p class="text-sm text-gray-600 mt-1">Create a new payment item for this payment.</p>
                </div>
        ...
        <!-- Content -->
        <div class="p-6">
            <form id="paymentForm" action="{{ route('payments.store', $payment->id) }}" method="POST" @submit.prevent="submitForm">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 bg-gray-800 text-gray-300 p-6 rounded-lg">
                        ...
                        <div class="text-sm text-gray-400">
                            ...
                            <p class="mb-2"><strong>Invoice Date:</strong>
                                {{ optional($payment->invoice)->invoice_date ? \Carbon\Carbon::parse($payment->invoice->invoice_date)->format('Y-m-d') : '—' }}
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="amount" id="amount" step="0.01"
                                    value="{{ old('amount') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('amount') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <input type="date" name="payment_date" id="payment_date"
                                    ...
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('payment_date') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <select name="payment_method" id="payment_method"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('payment_method') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="reference_number" id="reference_number"
                                    value="{{ old('reference_number', 'Cash') }}"
