    ...
    <div class="flex items-center justify-center min-h-screen px-6">
        <div class="grid w-full overflow-hidden bg-white rounded-lg shadow-lg ">
            ...
            <div class="max-w-md p-8 mx-auto">
                <div class="mb-8 ">
                    <h3 class="text-3xl font-bold text-gray-800">Reset Your Password</h3>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                    ...
                    <div class="relative mt-4" x-data="{ show: false }">
                        <label class="block text-sm mb-2 font-medium text-gray-700" for="password">Password</label>
                        <input
                            class="w-full py-3 pl-4 pr-10 text-sm text-gray-800 border border-gray-300 rounded-lg outline-blue-600"
                    ...
                    <!-- Confirm Password -->
                    <div class="relative mt-4" x-data="{ show: false }">
                        <label class="block text-sm mb-2 font-medium text-gray-700" for="password_confirmation">Confirm Password</label>
                        <input
                            class="w-full py-3 pl-4 pr-10 text-sm text-gray-800 border border-gray-300 rounded-lg outline-blue-600"
                            id="password_confirmation" x-bind:type="show ? 'text' : 'password'" name="password_confirmation" required="required"
