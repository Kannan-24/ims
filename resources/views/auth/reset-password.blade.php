        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input id="email" name="email" type="email" required
                    ...
                    placeholder="Enter your email address" value="{{ old('email', $request->email) }}" autocomplete="username" />
                <x-input-error :messages="$errors->get('email')" class="mt-2" />
            </div>

            <!-- OTP -->
            <div>
                <label for="otp" class="block text-sm font-medium text-gray-700 mb-2">One-time Password (OTP)</label>
