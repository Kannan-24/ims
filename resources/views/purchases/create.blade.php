        ...
        <div class="w-full mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <form action="{{ route('purchases.store') }}" method="POST">
                    ...
                    <!-- File Upload Section -->
                    <div class="mt-6 bg-gray-700 p-4 rounded-lg shadow-md">
                        <h3 class="text-2xl font-bold text-gray-200 mb-4">Upload File</h3>

                        <div>
                            <label for="purchase_file" class="block text-gray-300 font-semibold mb-2">Upload Image or
                                PDF:</label>
                            <input type="file" name="purchase_file" id="purchase_file"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function addProductRow() {
                ...
                row.innerHTML = `
                <td class="p-2">
                    <button type="button" class="open-modal bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md transition hidden">Select Product</button>
