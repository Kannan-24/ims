        ...
        <div class="w-full mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <form action="{{ route('purchases.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="purchase_date" id="purchase_date"
                                value="{{ old('purchase_date') }}" class="w-full px-4 py-3 border border-gray-700 bg-gray-800 text-gray-300 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required>
                        </div>
                    </div>
                    ...
                    <!-- File Upload Section -->
                    <div class="mt-6 bg-gray-700 p-4 rounded-lg shadow-md">
                        <h3 class="text-2xl font-bold text-gray-200 mb-4">Upload Files</h3>
                    ...
                    <div class="mt-6">
                        <button type="submit" class="px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg shadow-md transition">Submit Purchase</button>
                    </div>
                </form>
            </div>
        </div>
